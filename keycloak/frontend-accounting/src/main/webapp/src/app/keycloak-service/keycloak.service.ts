...
import LoginOptions = KeycloakModule.LoginOptions;
...
export class KeycloakService {
    ...
    setToken(token: string, refreshToken: string, idToken: string) {
      KeycloakService.keycloakAuth.setToken(token, refreshToken, idToken, 1);
    }
    ...
    createLoginUrl(loginOptions: LoginOptions) {
      KeycloakService.keycloakAuth.createLoginUrl(loginOptions);
    }
}
