...
(function( window, undefined ) {
    ...
    var Keycloak = function (config) {
            ...
            function processInit() {
                ...
                if (callback) {
                    ...
                    if (initOptions.refreshToken) {
                        kc.setToken(initOptions.token, initOptions.refreshToken, initOptions.idToken);
        ...
        kc.setToken = function setToken(token, refreshToken, idToken, timeLocal) {
            ...
            if (refreshToken) {
                ...
                kc.refreshTokenParsed = kc.decodeToken(refreshToken);
            } else {
            ...
            if (idToken) {
                kc.idToken = idToken;
                kc.idTokenParsed = kc.decodeToken(idToken);
            } else {
                delete kc.idToken;
            ...
            if (token) {
                kc.token = token;
                kc.tokenParsed = kc.decodeToken(token);
      ...
      kc.decodeToken = function decodeToken(str) {
            str = str.split('.')[1];
